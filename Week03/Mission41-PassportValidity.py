...
def check_validity(months_left, months_to_entry):
    ...
    if (months_left - months_to_entry) >= 6:        #Check if user's passport is valid for entry 
        ...
        print("Passport needs to be renewed") #Modify to display that user needs to renew his passport        
...
print("Valid") #Modify to print the result returned from function
