...
def calculate_DNAReverseComplement(dna1):
    ...
    for nitrogenous_base in reversed:
        index = base.index(nitrogenous_base)
        complement_char = complement[index]
        reverse_complement.append(complement_char)

    dna2 = ''.join(reverse_complement)
